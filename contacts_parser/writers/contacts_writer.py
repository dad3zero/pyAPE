    ...
    def __init__(self, class_level: str):
        ...
        if not self.destination_path.exists():
            with open(self.destination_path, "wt") as level_file:
                level_file.write("Title;First Name;Last Name;Children;E-mail Address;Gender;Keywords;Notes;Spouse\n")
    ...
    def add_informations(self, family: model.Family):
        ...
        with open(self.destination_path, "at") as level_file:
            for parent in family.parents:
                if parent.has_mail:
                    level_file.write(
                        f"{parent.title};{parent.firstname};{parent.lastname};{family.kid_name};{parent.mail};;;{parent.relationship} de {family.kid_name} classe {family.school_class};\n")
                else:
